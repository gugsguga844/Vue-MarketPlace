          ...
          <div class="col-12 col-md-6 mb-3 p-2">
            <div class="rounded-2 border-1 border-dark-subtle h-100">
              <div class="d-flex justify-content-between px-3 py-4">
                <div class="d-flex">
                  <div
                    class="rounded-circle bg-warning-subtle d-flex justify-content-center align-items-center"
                  ...
                  <div class="ms-2">
                    ...
                    <div class="buttons d-flex gap-2">
                      <button
                        ...
                        class="border-1 border-dark-subtle rounded-3 px-3 fs-7"
                      >
                        <i class="bi bi-pencil-square"></i>
                        <span class=""> Editar</span>
                      </button>
                      <button
                        @click.prevent="defineMainAddress(address.id)"
                        class="border-1 border-dark-subtle p-2 rounded-3 px-3 fs-7"
                      >
                        <i class="bi bi-pencil-square"></i>
                      ...
                      <button
                        ...
                        class="border-1 border-danger px-3 text-danger p-2 rounded-3 fs-7"
                      >
